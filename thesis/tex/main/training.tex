...
% For both networks similar experiments were performed, whereas each sub-experiment was repeated three times each with a different random seed.

% %The used seeds were: \{42, 1337, 0xDEADBEEF\}

% First an initial learning rate search was performed.
% Here seven learning rates were tested with the basic dataset.
...
% The second conducted experiment was the search for the optimal configuration of so-called offline augmentations.
...
% TODO why those three rotations
...
% The probability of occurrence of those augmentations was set to 50\%.
...
% TODO check
\subsection{Post-Training Fine-Tuning Experiments}
...
\subsubsection{Improve Model Uncertainty Through Voting Based Thresholding in \ac{WBF}}
