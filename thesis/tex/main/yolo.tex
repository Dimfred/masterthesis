...
During prediction time to further increase the detection performance a \ac{NMS} algorithm is applied.
More precisely \ac{DIoU}-\ac{NMS} \cite{diou}, since it has shown to perform better than classical \ac{NMS} \cite{soft_nms}, especially in occlusion cases.
