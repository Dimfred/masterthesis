...
\lstnewenvironment{algorithm}[1][] %defines the algorithm listing environment
{
    ...
    \lstset{ %this is the stype
        ...
        keywords={,input, then, output, return, datatype, function, in, if, else, foreach, do, while, begin, end, for} %add the keywords you want, or load a language as Rubens explains in his comment above.
        numbers=left,
