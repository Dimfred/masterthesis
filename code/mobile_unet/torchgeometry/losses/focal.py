...
class FocalLoss(nn.Module):
    ...
    def forward(self, input: torch.Tensor, target: torch.Tensor) -> torch.Tensor:
        ...
        has_nan = lambda x: torch.any(torch.isnan(x))

        # compute softmax over the classes axis
        input_soft = torch.clip(
            F.softmax(input, dim=1), self.eps, 1.0 - self.eps
        )  # + self.eps
        ...
        if self.reduction == "none":
            ...
            loss = torch.mean(loss_tmp, dim=2)
            if has_nan(loss):
                print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
                print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
                print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
                print("NaN in loss mean1")
                print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
                print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
                print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
                import sys
